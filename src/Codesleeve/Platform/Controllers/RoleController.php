...
class RoleController extends BaseController
{
	...
	public function index()
	{
		...
		$this->layout->nest('content', 'platform::roles.index', compact('roles'));
	}
	...
	public function create()
	{
		...
		$this->layout->nest('content', "platform::roles.create", compact('role'));
	}
	...
	public function show($id)
	{
		...
		$this->layout->nest('content', "platform::roles.show", compact('role'));
	}
	...
	public function edit($id)
	{
		...
		$this->layout->nest('content', "platform::roles.edit", compact('role'));
	}
