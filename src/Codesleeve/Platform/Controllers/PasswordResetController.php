...
class PasswordResetController extends BaseController
{
    ...
    public function create()
    {
        ...
        $this->layout->nest('content', "platform::password_reset.create", compact('token'));
    }
    ...
    public function store()
    {
        ...
        return Redirect::action($this->namespaced("SessionController@create"));
    }
    ...
    public function edit($token)
    {
        ...
        $this->layout->nest('content', "platform::password_reset.edit", compact('token'));
    }
